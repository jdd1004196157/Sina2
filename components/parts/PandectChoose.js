                        ...
                        <div style={styles.choose}>
                            ...
                            <Row >
                                ...
                                <Col xs={8} md={8} lg={5}  style={styles.col}>
                                    <span>业务线：</span>
                                    <Select  style={{ width: '65%'}} size="large" onChange={this.changeBusiness}  value={ListStore.data.pansect.PortData.subtype}>
                                        {business_select}
                                    </Select>
                                </Col>
                                <Col  xs={8} md={8} lg={10} style={styles.col}>
                                    <span>微博版本：</span>
                                    <Select   style={{ width: '60%',}} size="large" onChange={this.changeWbVersion}  value={ListStore.data.pansect.PortData.app_version}>
                                        {version_select}
                                    </Select>
                                </Col>
                                ...
                                <Col  xs={8} md={8} lg={5} style={styles.col}>
                                    <span>网络类型：</span>
                                    <Select style={{ width: '60%', }} size="large" onChange={this.changeNetType} value={ListStore.data.pansect.PortData.network_type}>
                                        {netType_select}
                                    </Select>
                                </Col>
                            ...
                            <Row>
                                ...
                                <Col xs={7} md={8} lg={5} style={styles.col}>
                                    <span>手机系统：</span>
                                    <Select style={{ width: '60%' }} size="large" onChange={this.changeSystem} value={ListStore.data.pansect.PortData.phonetype}>
                                        {computerType_select}
                                    </Select>
                                </Col>
                                ...
                                <Col xs={7} md={8} lg={5}  style={styles.col}>
                                    <span>时间粒度：</span>
                                    <Select  style={{ width: '50%' }} size="large" onChange={this.changeLd} value={ListStore.data.pansect.PortData.granularity}>
